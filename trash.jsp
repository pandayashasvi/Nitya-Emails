...
tbody:hover tr:hover td {
    ...
    <body>
        ...
        <div class="header">
             <h1>Hii <%  session=request.getSession();
                        ...
                        out.print(uname);%></h1>
        <h4>Your deleted mails are under here...</h4>
         </div>
  ...
  //  String s1 = (String)session.getAttribute("mailid");
    String s1 =(String)session.getAttribute("mailid");
    rs=st.executeQuery("SELECT * FROM trash where tfrom='"+s1+"'"); 
    while(rs.next()){
     ...
     <td><a style="color:black" href="http://localhost:8080/EmailSystem/completeDelete.jsp?id=<%out.print(s);%>">Delete</a></td>
     </tr>
