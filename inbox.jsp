...
tbody:hover tr:hover td {
    ...
    <body>
        ...
        <div class="header">
             <h1>Hii <%  session=request.getSession();
                        ...
                        out.print(uname);%></h1>
        <h4>check your new mails under here...</h4>
         </div>
  ...
  //  String s1 = (String)session.getAttribute("mailid");
    String s1 =(String)session.getAttribute("mailid");
    rs=st.executeQuery("SELECT * FROM inbox where ito='"+s1+"'"); 
    while(rs.next()){
     ...
     <tr>
         ...
         <td> <a style="color:black" href="http://localhost:8080/EmailSystem/msgbody.jsp?id=<%out.print(s);%>"> <% out.println(rs.getString(3)); %></a> </td>    
    
         <td><a style="color:black" href="http://localhost:8080/EmailSystem/delete.jsp?id=<%out.print(s);%>">Delete</a></td>
     </tr>
